...
public class Fractal implements IFractal {
	...
	private boolean generate(ByteBuffer buffer, int width, int height) {
		final float kConvertPixelToRealAxis = this.fractalIterationFunction.getFractalRegion().width()
		/ width;
		final float kConvertPixelToImagAxis = this.fractalIterationFunction.getFractalRegion().height()
		/ height;

		final int maxIterations = this.fractalIterationFunction.getMaxIterations();
		final RectF fractalRegion = this.fractalIterationFunction.getFractalRegion();
	...
	public boolean isInterestingAtAll(int width, int height) {
		...
		final float top = this.fractalIterationFunction.getFractalRegion().top;
		final float left = this.fractalIterationFunction.getFractalRegion().left;
